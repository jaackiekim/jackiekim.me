...
export default function Blog() {
  return (
    <div className="max-w-5xl mx-auto px-8">
      <h1 className="text-5xl mb-12">Publications</h1>
        ...
        {posts.map((post) => (
          ...
          >
            <Link to={`/blog/${post.slug}`} className="block group">
              <div className="mb-2">
                <span className="text-sm text-[#0039D7]/70">{post.date}</span>
              </div>
              <h2 className="text-2xl mb-2 group-hover:text-[#002BB4] transition-colors">
                {post.title}
              </h2>
